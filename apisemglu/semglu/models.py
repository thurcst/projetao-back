...
class Report(models.Model):
    ...
    def update_file_path(self, instance, filename):
        path = "reports"
    ...
    filePath = models.FileField(upload_to=update_file_path, max_length=500, null=True)  # type: ignore
...
class Review(models.Model):
    ...
    user = models.ForeignKey(  ## Chave estrangeira
        "users.UserProfile", related_name="reviews", on_delete=models.CASCADE
    )
